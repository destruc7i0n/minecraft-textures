// this ordering is from the Creative Inventory "Search Items" ItemGroup, extracted with a simple Fabric mod
// Last updated 1.21.7-rc.2
export const SEARCH_ITEMS_ORDERING = [
  'minecraft:oak_log',
  'minecraft:oak_wood',
