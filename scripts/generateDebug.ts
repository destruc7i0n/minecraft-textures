        ...
        <head>
          ...
          <style>
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .palette { display: grid; grid-template-columns: repeat(auto-fill, 64px); gap: 4px; padding-top: 12px; }
            .palette img { image-rendering: pixelated; width: 64px; height: 64px; background: #333; border: 1px solid #444; }
            ...
            td img { image-rendering: pixelated; width: 64px; height: 64px; display: block; background: #333; border: 1px solid #444; }
          </style>
        </head>
        <body>
          <h1>Debug - ${version}</h1>
